<template>
  <div class="console-wrap">
        ...
        <el-row :gutter="16">
          ...
          <el-col :span="3">
           ...
           <el-col :span="4">
            ...
            <el-col :span="2">
                <el-button type="danger" class="pull-right" style="width: 100%;" @click="infoAddStatus=true">新增</el-button>
            </el-col>
     ...
     <div class="console-page">
        <el-row>
          <el-col :span="6"><el-button size="small"  class="pull-left " @click="detelAll" >批量删除</el-button></el-col>
